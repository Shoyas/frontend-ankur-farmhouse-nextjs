...
const CustomerListPage = () => {
  ...
  const { data, isLoading, isError } = useGetAllUserQuery({ ...query });
  ...
  if (data) {
    ...
    if (Array.isArray(users)) {
      tableData = users.filter((item) => item.role === "customer");
    }
  }
  ...
  const columns = [
    ...
    },
    {
      ...
      render: function (data: any) {
        ...
        return (
          <>
            <Link href={`/super_admin/customer-list/edit/${data}`}>
              <Button
                style={{
                  margin: "0px 5px",
                }}
  ...
  return (
    <div style={{ margin: "15px" }}>
      ...
      <AFModal
        ...
        handleOk={() => deleteCustomerHandler(deleteId)}
      >
